...
decodeHourlyData =
    ...
    (De.at ["time"] (De.list De.int))
    (De.at ["temperature_2m"] (De.list De.float))
    (De.at ["precipitation"] (De.list De.float))
...
decodeWeatherData =
    ...
    (De.at ["hourly"] decodeHourlyData)
    (De.at ["utc_offset_seconds"] (De.int))
